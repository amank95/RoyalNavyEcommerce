          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="kid_kurta">Kids Kurtas</MenuItem>
                <MenuItem value="kid_shirt">K_Shirt</MenuItem>
                <MenuItem value="kid_jeans">K_Jeans</MenuItem>
                <MenuItem value="kid_sweater">K_Sweater</MenuItem>
                <MenuItem value="kid_tshirt">K_T-Shirt</MenuItem>
                <MenuItem value="kid_jacket">K_Jacket</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={12}>
